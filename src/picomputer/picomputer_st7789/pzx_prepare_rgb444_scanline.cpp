...
static uint32_t zx_colour_words[16] = {
  ...
  X2(VGA_RGB_444(0x0,0x0,0xb)), // Blue
  X2(VGA_RGB_444(0xb,0x0,0x0)), // Red
  X2(VGA_RGB_444(0xb,0x0,0xb)), // Magenta
  X2(VGA_RGB_444(0x0,0xb,0x0)), // Green
  X2(VGA_RGB_444(0x0,0xb,0xb)), // Cyan
  X2(VGA_RGB_444(0xb,0xb,0x0)), // Yellow
  X2(VGA_RGB_444(0xb,0xb,0xb)), // White
